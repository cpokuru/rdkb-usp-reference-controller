...
def api_ai_chat():
    ...
    # Try OpenAI if API key is configured via the OPENAI_API_KEY environment variable.
    # When set, responses will be generated by GPT-3.5-turbo; otherwise rule-based responses are used.
